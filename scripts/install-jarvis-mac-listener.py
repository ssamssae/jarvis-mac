...
def main():
    ...
    for name in ('jarvis_mac_voice.py','jarvis_cursor_qa.py','jarvis_mac_listener.py','whisper_cpp_worker.py','jarvis_smart_home.py','jarvis_weather.py','jarvis_status_light.py'):
